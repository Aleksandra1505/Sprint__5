...
def test_successful_registration():
    ...
    driver.find_element(*NAME_INPUT).send_keys("Сашаа")
    time.sleep(2)
    driver.find_element(*EMAIL_INPUT).send_keys("antropova4155645@yandex.ru")
    time.sleep(2)
...
def test_failed_registration():
    ...
    driver.find_element(*NAME_INPUT).send_keys("Сашна")
    time.sleep(2)
    driver.find_element(*EMAIL_INPUT).send_keys("antropodva151@yande.ru")
    time.sleep(2)
